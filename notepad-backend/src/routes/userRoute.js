...
router.route('/Register').post(userController.CreateUser, userController.RegisterSendMail); // Eğerki bir yerden /Register endpointi ile bir post isteği gelirse userControllerda yazmış olduğumuz createUser fonksiyonuna yönlendiriyoruz ve eğerki başarılı olursa bir sonraki işlem olan mail gönderiyoruz. 
